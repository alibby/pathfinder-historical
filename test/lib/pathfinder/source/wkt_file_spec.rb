...
describe Pathfinder::Source::WKTFile do
  subject { Pathfinder::Source::WKTFile.new('data/wkt/simple.wkt').read }
  ...
  describe "read from WKT with a single MULTILINESTRING" do
    subject { Pathfinder::Source::WKTFile.new('data/wkt/simple_noded.wkt').read }
